...
var testDevice = Device{
	...
	IsGenerateDefaultPassword: Bool(false),
	Throughput:                Int(1),
...
func verifyDeviceRequest(t *testing.T, device Device, req api.DeviceRequest) {
	...
	assert.Equal(t, device.IsGenerateDefaultPassword, req.IsGenerateDefaultPassword, "Generate Default Password boolean value matches")
