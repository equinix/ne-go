...
//Requests are executed against given url, pagination aspects are controlled with PagingConfig
func (c RestClient) GetPaginated(url string, result interface{}, conf *PagingConfig) ([]interface{}, error) {
